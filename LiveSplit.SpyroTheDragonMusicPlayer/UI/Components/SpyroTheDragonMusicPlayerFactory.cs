...
{
    public class SpyroTheDragonMusicPlayerFactory : IComponentFactory
    {
        // The displayed name of the component in the Layout Editor.
        public string ComponentName => "Spyro the Dragon Music Player";

        public string Description => "Plays custom level music in Spyro the Dragon.";
        ...
        public IComponent Create(LiveSplitState state) => new SpyroTheDragonMusicPlayerComponent(state);
